...
class ProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'product_name'       =>  'required|regex:/^[(a-zA-Z0-9\-\s)]+$/u|min:3|max:50|unique:products,product_name,NULL,id,deleted_at,NULL',
            'product_code'       => 'required|max:10|regex:/^[(a-zA-Z0-9)]+$/u|unique:products,product_code,NULL,id,deleted_at,NULL',
